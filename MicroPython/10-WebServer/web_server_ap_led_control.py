...
Description: Web server in Access Point (AP) mode for LED control. Creates a Wi-Fi hotspot and provides a web interface to toggle an LED (GPIO 22).
...
Link:
- Tutorial [ZH]: https://docs.waveshare.net/ESP32-MicroPython-Tutorials/Web-Server#web-server-led-ap
"""
...
# Wi-Fi configuration
SSID = "ESP32-C6-TEST"  # Set hotspot name
