...
Description: 
    ...
    This code acts as the RECEIVER and requires `uart_communication_sender.py` (Sender) running on another ESP32-C6-Zero.
...
Wiring:
    ...
    LED (GPIO 22)                 Button (GPIO 22)
    RX (GPIO 2)        <------    TX (GPIO 19)
    TX (GPIO 3)        ------>    RX (GPIO 20)
    GND                <------>   GND
